...
//            LinearGradient(gradient: Gradient(on: themeProvider, for: .backgroundGradient), startPoint: .leading, endPoint: .trailing)
//        }
//        let view2 = SpyView(themeProvider: themeProvider) { themeProvider in
//            LinearGradient(gradient: Gradient(on: themeProvider, for: .backgroundGradient, theme: .bluoTheme), startPoint: .leading, endPoint: .trailing)
//        }
//        let view3 = SpyView(themeProvider: themeProvider) { themeProvider in
//            LinearGradient(gradient: Gradient(on: themeProvider, for: .backgroundGradient, preferredAppearance: .dark), startPoint: .leading, endPoint: .trailing)
//        }
//        let view4 = SpyView(themeProvider: themeProvider) { themeProvider in
//            LinearGradient(gradient: Gradient(on: themeProvider, for: .backgroundGradient, preferredAppearance: .light, theme: .jadoTheme), startPoint: .leading, endPoint: .trailing)
//        }
